...
Searches for new useful sources (GitHub business frameworks, HN business building
threads, resource lists) and proposes them as candidates in sources.yaml.
"""
import os
import sys
import json
...
GITHUB_SOURCE_QUERIES = [
    "awesome business model ai",
    "business blueprint framework startup",
    "go to market strategy ai tools",
    "lean startup canvas framework",
    "ai business guide resources list",
]

HN_SOURCE_QUERIES = [
    "best business building resources AI",
    "business framework startup list",
    "go to market AI business",
]


def fetch_json(url: str) -> dict | list | None:
    headers = {"User-Agent": "awesome-ai-business-blueprint/1.0 source-updater"}
    if _GITHUB_TOKEN:
...
def main() -> None:
    ...
    print("=== Source discovery run (Awesome AI Business Blueprint) ===")
